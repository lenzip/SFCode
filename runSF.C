{
   ...
   //gROOT->Macro("computeSFsVertex.C(\"total_2017.root\", \"b\", \"Full2017SVb\")");
   gROOT->Macro("computeSFsVertex.C(\"total_2017.root\", \"c\", \"Full2017SVc\")");
   gROOT->Macro("computeSFsVertex.C(\"total_2017.root\", \"l\", \"Full2017SVl\")");
}
