{
   ...
   //setTDRStyle();
   gROOT->Macro("load.C");
   gROOT->Macro("computeSFsWithJPandSV.C(\"total_2017.root\", \"L\", \"Full2017test\")");
   //gROOT->Macro("computeSFsWithJPandSV.C(\"total_2017.root\", \"M\", \"Full2017test\")");
   gROOT->Macro("computeSFsWithJPandSV.C(\"total_2017.root\", \"T\", \"Full2017test\")");
