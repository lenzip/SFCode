...
void computeSFsWithJPandSV(const char* filein, const char* wp, const char* outdir)
{
   ...
   for (unsigned ibin = 0; ibin < 9; ++ibin){
     ...
     cfJPtagged->SetData(Form("data/JP__ptbin_%s_DeepCSVBDisc%s", thebin, wp));
     cfJPtagged->SetDataTag(Form("data/JP__ptbin_%s_DeepCSVBDisc%sSV", thebin,wp));
     cfJPtagged->SetDataUntag(Form("data/JP__ptbin_%s_DeepCSVBDisc%sNoSV", thebin,wp));

     cfJPtagged->AddTemplate("b",Form("mc/JP__ptbin_%s_b_DeepCSVBDisc%s", thebin, wp),2);
     cfJPtagged->AddTemplate("c",Form("mc/JP__ptbin_%s_c_DeepCSVBDisc%s", thebin, wp),3);
     cfJPtagged->AddTemplate("l",Form("mc/JP__ptbin_%s_l_DeepCSVBDisc%s", thebin, wp),4);

     cfJPtagged->AddTemplateTag("b",Form("mc/JP__ptbin_%s_b_DeepCSVBDisc%s_SV", thebin, wp),2);
     cfJPtagged->AddTemplateTag("c",Form("mc/JP__ptbin_%s_c_DeepCSVBDisc%s_SV", thebin, wp),3);
     cfJPtagged->AddTemplateTag("l",Form("mc/JP__ptbin_%s_l_DeepCSVBDisc%s_SV", thebin, wp),4);

     cfJPtagged->AddTemplateUntag("b",Form("mc/JP__ptbin_%s_b_DeepCSVBDisc%s_NoSV", thebin, wp),2);
     cfJPtagged->AddTemplateUntag("c",Form("mc/JP__ptbin_%s_c_DeepCSVBDisc%s_NoSV", thebin, wp),3);
     cfJPtagged->AddTemplateUntag("l",Form("mc/JP__ptbin_%s_l_DeepCSVBDisc%s_NoSV", thebin, wp),4);
     ...
     for (unsigned int ifit = 0; ifit < 7; ++ifit){
       ...
       if (ifit == 4) { //use MC JP calib
        ...
        cfJPtagged->SetData(Form("data_inverted/JP__ptbin_%s_DeepCSVBDisc%s", thebin, wp));
        cfJPtagged->SetDataTag(Form("data_inverted/JP__ptbin_%s_DeepCSVBDisc%sSV", thebin,wp));
        cfJPtagged->SetDataUntag(Form("data_inverted/JP__ptbin_%s_DeepCSVBDisc%sNoSV", thebin,wp));
